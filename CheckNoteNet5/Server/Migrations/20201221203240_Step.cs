    ...
    public partial class Step : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contents", x => x.NoteId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseLikes", x => new { x.CourseId, x.UserId });
                    table.ForeignKey(
                        name: "FK_CourseLikes_AspNetUsers_CourseId",
                        column: x => x.CourseId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseLikes_Courses_UserId",
                        column: x => x.UserId,
